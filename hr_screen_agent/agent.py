...
from hr_screen_agent.tools import clear_thoughts, think, web_search, get_job_description, get_cv, get_resume
...
def create_hr_screen_agent(debug: bool = False) -> PregelProtocol:
    ...
    return create_react_agent(
        ...
        tools=[think, clear_thoughts, web_search, get_job_description, get_cv, get_resume],
